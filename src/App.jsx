    ...
    <div className="app">
      ...
      >
        <section className="hero">
          <h1 id="heroTitle">
            {birthdayReached ? (
              <>
                Happy Birthday <span className="highlight">Jahvi</span> 🎂
              </>
            ) : (
              <>
                Counting down to <span className="highlight">Jahvi's</span>{" "}
                special day 🎂
              </>
            )}
          </h1>
      ...
      >
        ...
        <section className="final">
          <h2 className="final-message">HAPPY BIRTDAY JHIM JHIM , Small Present for You</h2>
          <p className="final-subtitle">Made with Late Night , coffee , Affection.</p>
        </section>
      </div>
